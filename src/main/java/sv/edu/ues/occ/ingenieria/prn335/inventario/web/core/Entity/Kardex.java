...
@Table(name = "kardex", schema = "public", indexes = {
        @Index(name = "fki_fk_kardex_almacen", columnList = "id_almacen")
})
public class Kardex {
    @Id
    ...
    private sv.edu.ues.occ.ingenieria.prn335.inventario.web.core.Entity.VentaDetalle idVentaDetalle;
    ...
    public sv.edu.ues.occ.ingenieria.prn335.inventario.web.core.Entity.VentaDetalle getIdVentaDetalle() {
        return idVentaDetalle;
    }

    public void setIdVentaDetalle(sv.edu.ues.occ.ingenieria.prn335.inventario.web.core.Entity.VentaDetalle idVentaDetalle) {
